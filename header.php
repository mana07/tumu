        ...
        <nav id="sp-nav">
          ...
          <div>
            <div class="sp-menu">
              ...
              <div id="sp-sns">
                <img id="Twitter" src="<?php echo get_template_directory_uri(); ?>/images/2021 Twitter logo - black.png" alt="twitterのロゴ">
                <img id="Insta" src="<?php echo get_template_directory_uri(); ?>/images/Instagram_Glyph_Black.png" alt="instagramのロゴ">
              </div>
            </div>
          </div>
        </nav>
